...
export const dict = {
  ...
  "provider.custom.field.apiKey.description": "可选。已保存的密钥不会显示；留空可保留当前密钥，也可通过请求头管理认证。",
  "provider.custom.field.endpoint.label": "API 格式",
  "provider.custom.field.endpoint.chat": "Chat Completions",
  "provider.custom.field.endpoint.responses": "Responses",
  "provider.custom.field.endpoint.description": "GPT-5.6、GPT-6 等要求 Responses API 的模型请选择 Responses。",
  "provider.custom.edit": "编辑提供商",
  "provider.custom.saved": "已保存的自定义提供商",
  "provider.custom.delete.title": "删除自定义提供商",
  "provider.custom.delete.confirm": "确定删除 {{provider}} 吗？其模型、配置和已保存的认证信息将被移除。",
  "provider.custom.delete.success.title": "自定义提供商已删除",
  "provider.custom.delete.success.description": "已移除 {{provider}} 及其保存的配置。",
  ...
  "provider.custom.models.advanced": "高级模型能力",
  "provider.custom.json.label": "模型配置（JSONC）",
  "provider.custom.json.copy": "复制模型",
  "provider.custom.json.import": "导入 JSONC",
  "provider.custom.json.export": "导出 JSONC",
  "provider.custom.json.template": "应用模板",
  "provider.custom.json.format": "格式化",
  "provider.custom.json.reset": "恢复已保存配置",
  "provider.custom.json.preview": "预览配置",
  "provider.custom.json.save": "保存此模型",
  "provider.custom.json.saved": "模型配置已保存",
  "provider.custom.json.saveProvider": "保存连接设置",
  "provider.custom.json.help":
    "JSONC 支持注释和末尾逗号。按 Ctrl+Space 查看字段补全。关闭窗口后草稿仍会保留；请分别保存各模型。",
  "provider.custom.json.templateNote": "请将 contextWindow: 0 替换为提供商文档中的上限，并确认支持的推理强度后再保存。",
  "provider.custom.json.previewNote":
    "此处预览模型与提供商配置。项目覆盖、插件和运行时限制仍可能改变最终请求。连接信息不显示认证凭据。",
  "provider.custom.models.contextWindow": "上下文窗口",
  "provider.custom.models.maxInputTokens": "最大输入 Token",
  "provider.custom.models.contextWindow.description": "请填写提供商文档中的上下文窗口大小，以启用自动上下文压缩。",
  "provider.custom.models.system.auto": "自动",
  "provider.custom.models.system.remove": "不发送系统消息",
  "provider.custom.models.maxOutputTokens": "最大输出 Token",
  "provider.custom.models.reservedOutputTokenSpace.description":
    "上下文压缩前预留的空间。留空时使用输出上限。此项不限制回复长度。",
  "provider.custom.models.reasoningEfforts": "支持的推理强度",
  "provider.custom.models.reasoningEfforts.description":
    "填写 API 支持的值，以英文逗号分隔，例如 low, medium, high。仅在模型允许关闭推理时添加 none。",
  "provider.custom.models.supportsTemperature": "支持温度参数",
  "provider.custom.models.supportsToolCalls": "支持工具调用",
  "provider.custom.error.capabilities":
    "请检查 Token 上限和推理强度。上限须为上下文窗口范围内的整数，默认推理强度须在支持的列表中。",
  "provider.custom.models.reservedOutputTokenSpace": "预留输出 Token",
  "provider.custom.models.supportsSystemMessage": "系统消息角色",
  "provider.custom.models.specialToolFormat": "工具格式",
  "provider.custom.models.supportsReasoning": "支持推理",
  "provider.custom.models.canTurnOffReasoning": "允许关闭推理",
  "provider.custom.models.canIOReasoning": "在输入和输出中包含推理",
  "provider.custom.models.reasoningDefault": "默认推理强度",
  "provider.custom.models.supportsFIM": "支持 FIM",
  "provider.custom.models.supportsVision": "支持视觉输入",
