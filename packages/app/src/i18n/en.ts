...
export const dict = {
  ...
  "provider.custom.field.apiKey.description":
    "Optional. Stored keys are hidden; leave empty to keep the current key or when you manage auth via headers.",
  "provider.custom.field.endpoint.label": "API format",
  "provider.custom.field.endpoint.chat": "Chat Completions",
  "provider.custom.field.endpoint.responses": "Responses",
  "provider.custom.field.endpoint.description":
    "Use Responses for GPT-5.6, GPT-6, and other models that require the Responses API.",
  "provider.custom.edit": "Edit provider",
  "provider.custom.saved": "Saved custom providers",
  "provider.custom.delete.title": "Delete custom provider",
  "provider.custom.delete.confirm":
    "Delete {{provider}}? Its models, configuration, and saved credentials will be removed.",
  "provider.custom.delete.success.title": "Custom provider deleted",
  "provider.custom.delete.success.description": "{{provider}} and its saved configuration were removed.",
  ...
  "provider.custom.models.advanced": "Advanced model capabilities",
  "provider.custom.json.label": "Model configuration (JSONC)",
  "provider.custom.json.copy": "Duplicate model",
  "provider.custom.json.import": "Import JSONC",
  "provider.custom.json.export": "Export JSONC",
  "provider.custom.json.template": "Apply template",
  "provider.custom.json.format": "Format",
  "provider.custom.json.reset": "Restore saved configuration",
  "provider.custom.json.preview": "Preview configuration",
  "provider.custom.json.save": "Save this model",
  "provider.custom.json.saved": "Model configuration saved",
  "provider.custom.json.saveProvider": "Save connection settings",
  "provider.custom.json.help":
    "JSONC supports comments and trailing commas. Press Ctrl+Space for field suggestions. Drafts are retained when you close this dialog. Save each model separately.",
  "provider.custom.json.templateNote":
    "Replace contextWindow: 0 with your provider's documented limit. Verify supported reasoning efforts before saving.",
  "provider.custom.json.previewNote":
    "Preview of model and provider settings. Project overrides, plugins, and runtime limits may change the final request. Credentials are excluded from connection details.",
  "provider.custom.models.contextWindow": "Context window",
  "provider.custom.models.maxInputTokens": "Maximum input tokens",
  "provider.custom.models.contextWindow.description":
    "Enter the provider's documented context window to enable automatic context compaction.",
  "provider.custom.models.system.auto": "Automatic",
  "provider.custom.models.system.remove": "Omit system messages",
  "provider.custom.models.maxOutputTokens": "Maximum output tokens",
  "provider.custom.models.reservedOutputTokenSpace.description":
    "Space reserved before context compaction. Leave empty to use the output limit. This does not limit response length.",
  "provider.custom.models.reasoningEfforts": "Supported reasoning efforts",
  "provider.custom.models.reasoningEfforts.description":
    "Comma-separated API values, such as low, medium, high. Include none only if the model can turn off reasoning.",
  "provider.custom.models.supportsTemperature": "Supports temperature",
  "provider.custom.models.supportsToolCalls": "Supports tool calls",
  "provider.custom.error.capabilities":
    "Check token limits and reasoning efforts. Limits must be whole numbers within the context window; the default effort must be supported.",
  "provider.custom.models.reservedOutputTokenSpace": "Reserved output tokens",
  "provider.custom.models.supportsSystemMessage": "System message role",
  "provider.custom.models.specialToolFormat": "Tool format",
  "provider.custom.models.supportsReasoning": "Supports reasoning",
  "provider.custom.models.canTurnOffReasoning": "Can turn off reasoning",
  "provider.custom.models.canIOReasoning": "Include reasoning in input/output",
  "provider.custom.models.reasoningDefault": "Default reasoning effort",
  "provider.custom.models.supportsFIM": "Supports FIM",
  "provider.custom.models.supportsVision": "Supports vision",
